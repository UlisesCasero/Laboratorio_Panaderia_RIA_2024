...
const enviar_mail2 = (email, password) => {
    let transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: process.env.MAIL_USER,
...
module.exports = { enviar_mail_pedido, enviar_mail, enviar_mail_cambio_constrasenia, enviar_reset_constrasenia, enviar_mail2 }; // Exporta enviar_mail como una propiedad de un objeto
